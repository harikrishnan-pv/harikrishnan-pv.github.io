...
export default function Lanyard({
  ...
  // On-screen size scales as 1/distance: desktop 18 -> 12 is 1.5x,
  // mobile 20 -> 16.7 is ~1.2x (a full 1.5x would overflow narrow screens).
  const cameraDistance = isMobile ? 16.7 : 12;
  ...
  const bandPosition = isMobile ? [0, 4.8, 0] : [-1.8, 4.5, 0];
