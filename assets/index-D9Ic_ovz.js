const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/hero-lanyard-DQ0NBFPe.js","assets/hero-lanyard-D83VCvhA.css"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function i(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function n(s){if(s.ep)return;s.ep=!0;const l=i(s);fetch(s.href,l)}})();const B="modulepreload",O=function(e){return"/"+e},A={},T=function(t,i,n){let s=Promise.resolve();if(i&&i.length>0){let c=function(a){return Promise.all(a.map(u=>Promise.resolve(u).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),m=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=c(i.map(a=>{if(a=O(a),a in A)return;A[a]=!0;const u=a.endsWith(".css"),d=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${d}`))return;const g=document.createElement("link");if(g.rel=u?"stylesheet":B,u||(g.as="script"),g.crossOrigin="",g.href=a,m&&g.setAttribute("nonce",m),document.head.appendChild(g),u)return new Promise((f,p)=>{g.addEventListener("load",f),g.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${a}`)))})}))}function l(c){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=c,window.dispatchEvent(o),!o.defaultPrevented)throw c}return s.then(c=>{for(const o of c||[])o.status==="rejected"&&l(o.reason);return t().catch(l)})};function $(){const e=document.documentElement,t=document.getElementById("themeToggle");localStorage.theme==="light"?e.classList.remove("dark"):e.classList.add("dark"),t==null||t.addEventListener("click",()=>{e.classList.contains("dark")?(e.classList.remove("dark"),localStorage.theme="light"):(e.classList.add("dark"),localStorage.theme="dark")})}function D(){const e=document.getElementById("scroll-progress"),t=document.querySelector(".parallax-hero"),i=document.querySelectorAll('.pill-link[href^="#"]');let n=!1;window.addEventListener("scroll",()=>{n||(n=!0,requestAnimationFrame(()=>{const c=window.scrollY,o=document.documentElement.scrollHeight-window.innerHeight,m=o>0?c/o:0;e&&(e.style.width=`${m*100}%`),t&&c<window.innerHeight*1.2&&(t.style.transform=`translateY(${c*.22}px)`),n=!1}))},{passive:!0});const s=document.querySelectorAll("section[id], footer[id]"),l=new IntersectionObserver(c=>{c.forEach(o=>{if(o.isIntersecting){const m=o.target.getAttribute("id");i.forEach(a=>{a.classList.toggle("active",a.getAttribute("href")===`#${m}`)})}})},{threshold:.4});s.forEach(c=>l.observe(c))}function q(){const e=document.getElementById("typewriter-text"),t=document.getElementById("typewriter-cursor");if(!e)return;const i="Lead Product & Platform Engineer | AI-Native Systems";let n=0;const s=setInterval(()=>{n<i.length?(e.textContent+=i[n],n++):(clearInterval(s),t==null||t.classList.add("blink"))},40)}function H(){const e=new IntersectionObserver(i=>{i.forEach(n=>{n.isIntersecting&&(n.target.classList.add("is-visible"),e.unobserve(n.target))})},{threshold:.08});document.querySelectorAll("[data-reveal]").forEach(i=>e.observe(i));const t=document.querySelector(".timeline-container");if(t){const i=new IntersectionObserver(n=>{n.forEach(s=>{s.isIntersecting&&(s.target.classList.add("is-visible"),i.unobserve(s.target))})},{threshold:.05});i.observe(t)}}const k={officekit:{title:"OfficeKit HRMS — Enterprise Platform Revamp",tags:["Enterprise SaaS","Microservices","AI","Java Spring Boot","GCP","Claude Code / Cursor"],description:"Architected the enterprise modernization of OfficeKit HRMS on GCP — migrating monolithic workflows to decoupled Spring Boot microservices, an automated shift scheduling engine, and an AI-driven LMS with multimodal evaluation pipelines.",images:["images/officekit/entity-settings.png","images/officekit/shift-management.png","images/officekit/sentinel-insight.png"],content:`
      <div class="space-y-8">
        <div>
    ...
    `;t.innerHTML=d,e.classList.remove("hidden"),document.body.style.overflow="hidden",n=0,l(),(g=document.getElementById("prevSlideBtn"))==null||g.addEventListener("click",()=>{const p=k[s].images.length;n=(n-1+p)%p,l()}),(f=document.getElementById("nextSlideBtn"))==null||f.addEventListener("click",()=>{const p=k[s].images.length;n=(n+1)%p,l()}),document.querySelectorAll(".carousel-indicator").forEach(p=>{p.addEventListener("click",()=>{n=parseInt(p.dataset.index,10),l()})})}function o(){e.classList.add("hidden"),document.body.style.overflow=""}i==null||i.addEventListener("click",o),e==null||e.addEventListener("click",m=>{m.target===e&&o()}),document.addEventListener("keydown",m=>{m.key==="Escape"&&!(e!=null&&e.classList.contains("hidden"))&&o()}),window.openProjectModal=c}function N(){window.innerWidth<768||document.querySelectorAll(".card").forEach(e=>{e.addEventListener("mousemove",t=>{const i=e.getBoundingClientRect(),n=(t.clientX-i.left)/i.width-.5,s=(t.clientY-i.top)/i.height-.5;e.style.transform=`perspective(800px) rotateX(${-s*10}deg) rotateY(${n*10}deg) translateY(-4px)`,e.style.transition="transform 0.05s ease"}),e.addEventListener("mouseleave",()=>{e.style.transform="",e.style.transition="transform 0.5s ease, box-shadow 0.3s ease"})})}function _(){if(!window.matchMedia("(hover: hover) and (pointer: fine)").matches)return;const e=document.createElement("div");e.id="cursor-dot";const t=document.createElement("div");t.id="cursor-ring",document.body.appendChild(e),document.body.appendChild(t);let i=-200,n=-200,s=-200,l=-200;window.addEventListener("mousemove",o=>{i=o.clientX,n=o.clientY},{passive:!0}),document.querySelectorAll("a, button, .card, .btn-cta").forEach(o=>{o.addEventListener("mouseenter",()=>t.classList.add("expanded")),o.addEventListener("mouseleave",()=>t.classList.remove("expanded"))});function c(){s+=(i-s)*.12,l+=(n-l)*.12,e.style.transform=`translate(${i-3}px, ${n-3}px)`,t.style.transform=`translate(${s-16}px, ${l-16}px)`,requestAnimationFrame(c)}requestAnimationFrame(c)}function Y(){window.matchMedia("(hover: hover)").matches&&document.querySelectorAll(".btn-cta").forEach(e=>{e.addEventListener("mouseenter",()=>{e.style.transition="none"}),e.addEventListener("mousemove",t=>{const i=e.getBoundingClientRect(),n=i.left+i.width/2,s=i.top+i.height/2,l=(t.clientX-n)*.28,c=(t.clientY-s)*.28;e.style.transform=`translate(${l}px, ${c}px)`}),e.addEventListener("mouseleave",()=>{e.style.transform="",e.style.transition="transform 0.45s cubic-bezier(0.16, 1, 0.3, 1)"})})}const I=["#ef4444","#dc2626","#e11d48","#f43f5e","#fca5a5"],z=62,P=130,C=115,R=32,M=.38;function U(){const e=document.getElementById("particle-canvas");if(!e)return;const t=e.getContext("2d");let i=[],n=-999,s=-999,l=null;function c(){return document.documentElement.classList.contains("dark")}function o(){const{width:d,height:g}=e;i=Array.from({length:z},()=>({x:Math.random()*d,y:Math.random()*g,vx:(Math.random()-.5)*M*2,vy:(Math.random()-.5)*M*2,r:Math.random()*1.8+1.2,color:I[Math.floor(Math.random()*I.length)],ox:0,oy:0}))}function m(){e.width=e.offsetWidth||window.innerWidth,e.height=e.offsetHeight||window.innerHeight,o()}function a(){const{width:d,height:g}=e,f=c();t.clearRect(0,0,d,g);for(const r of i){const x=r.x-n,v=r.y-s,h=Math.hypot(x,v);if(h<C&&h>1){const b=1-h/C;r.ox+=x/h*b*R*.07,r.oy+=v/h*b*R*.07}r.ox*=.87,r.oy*=.87,r.x+=r.vx,r.y+=r.vy,r.x<-20?r.x=d+20:r.x>d+20&&(r.x=-20),r.y<-20?r.y=g+20:r.y>g+20&&(r.y=-20)}const p=f?.5:.22;for(let r=0;r<i.length-1;r++){const x=i[r],v=x.x+x.ox,h=x.y+x.oy;for(let b=r+1;b<i.length;b++){const y=i[b],S=y.x+y.ox,E=y.y+y.oy,L=Math.hypot(v-S,h-E);L<P&&(t.beginPath(),t.moveTo(v,h),t.lineTo(S,E),t.strokeStyle=`rgba(239,68,68,${((1-L/P)*p).toFixed(3)})`,t.lineWidth=.75,t.stroke())}}t.globalAlpha=f?1:.55;for(const r of i)t.beginPath(),t.arc(r.x+r.ox,r.y+r.oy,r.r,0,Math.PI*2),t.fillStyle=r.color,t.fill();t.globalAlpha=1,l=requestAnimationFrame(a)}e.addEventListener("mousemove",d=>{const g=e.getBoundingClientRect();n=d.clientX-g.left,s=d.clientY-g.top},{passive:!0}),e.addEventListener("mouseleave",()=>{n=-999,s=-999}),new ResizeObserver(()=>{cancelAnimationFrame(l),m(),l=requestAnimationFrame(a)}).observe(e),m(),l=requestAnimationFrame(a)}const X="/assets/card-CxpzKIJB.glb";fetch(X).catch(()=>{});let F=!1;function w(){F||(F=!0,T(()=>import("./hero-lanyard-DQ0NBFPe.js"),__vite__mapDeps([0,1])).then(e=>e.mountLanyard()).catch(e=>console.warn("Lanyard failed to load:",e)))}function K(){const e=navigator.connection||navigator.mozConnection||navigator.webkitConnection;e&&(e.saveData||/^(slow-2g|2g)$/.test(e.effectiveType||""))||(document.readyState==="complete"?w():(window.addEventListener("load",w,{once:!0}),setTimeout(w,4e3)))}document.addEventListener("DOMContentLoaded",()=>{$(),D(),q(),H(),j(),N(),_(),Y(),U();const e=document.getElementById("year");e&&(e.textContent=new Date().getFullYear()),K()});export{T as _};
